        ...
        switch (type) {
            ...
            case 'po':
                ...
                formHTML = `
                    ...
                    <div class="form-group"><label>Vendor</label><select name="id_vendor"><option value="">- Pilih Vendor -</option>${vendorOptions}</select></div>
                    <div class="form-group"><label>Client</label><select name="id_client"><option value="">- Pilih Client -</option>${clientOptionsForPo}</select></div>
            ...
            case 'memo':
                ...
                formHTML = `
                    ...
                    <div class="form-group"><label>Client</label><select name="id_client"><option value="">- Pilih Client -</option>${clientOptionsForMemo}</select></div>
            ...
            case 'invoice':
                ...
                formHTML = `
                    ...
                    <div class="form-group"><label>Status PPN</label><select name="ppn_status"><option value="PKP">PKP</option><option value="Non PKP">Non PKP</option></select></div>
                    <div class="form-group"><label>Status Invoice</label><select name="status_invoice"><option value="Unbill">Unbill</option><option value="Bill">Bill</option><option value="Paid">Paid</option></select></div>`;
                break;
            case 'client':
                formHTML = `
